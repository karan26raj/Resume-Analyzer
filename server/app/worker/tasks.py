...
def index_document_task(self, document_type: str, document_id: int) -> None:
    """Chunk, embed and store one resume or job; retry transient failures with exponential backoff."""
    ...
    try:
        ...
        countdown = settings.INDEX_TASK_RETRY_BASE_SECONDS * 2 ** self.request.retries  # 10s, 20s, 40s…
